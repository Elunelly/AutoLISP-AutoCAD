...
;   Converts a RGB color into an OLE color.                                                                                                         ;
;                                                                                                                                                   ;
;--- Declaration of the arguments                                                                                                                   ;
; The function (LM:RGB->OLE) have 3 argument(s) :                                                                                                   ;
...
;                                                                                                                                                   ;
;--- Return                                                                                                                                         ;
;   The function (LM:RGB->OLE) returns the OLE color code, as integer                                                                               ;
;     Ex. : (LM:RGB->OLE 23 42 69) returns 4532759                                                                                                  ;
;           (LM:RGB->OLE 0 0 0) returns 0                                                                                                           ;
;           (LM:RGB->OLE 255 255 255) returns 16777215                                                                                              ;
;           (LM:RGB->OLE 255 0 0) returns 255                                                                                                       ;
;           (LM:RGB->OLE 0 255 0) returns 65280                                                                                                     ;
;           (LM:RGB->OLE 0 0 255) returns 16711680                                                                                                  ;
;                                                                                                                                                   ;
